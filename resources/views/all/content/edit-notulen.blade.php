                    ...
                    <div class="row">
                            ...
                            <div class="form-group" id="data_1"><label class="col-lg-2 control-label">Tanggal</label>
                                <div class="col-lg-12">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" name="tgl" id="tgl" class="form-control" value="{{$notulen->tgl}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group"><label>Pukul</label>
                                <div class="col-lg-12">
                                    <input value="{{$notulen->pukul}}" placeholder="00:00 - 00:00" name="pukul" id="pukul" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-4">
                            <div class="col-lg-12">
                                <div class="form-group"><label>Tempat</label>
                                    <input value="{{$notulen->tempat}}" placeholder="Tempat" name="tempat" id="tempat" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="col-lg-12">
                                <div class="form-group"><label>Acara</label>
                                    <input value="{{$notulen->acara}}" placeholder="Acara" name="acara" id="acara" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
