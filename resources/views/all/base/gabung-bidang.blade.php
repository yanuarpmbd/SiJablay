        ...
        <main>
            <div class="tabs-container">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#tab-1">Rekap Kemitraan</a></li>
                    <li class=""><a data-toggle="tab" href="#tab-2">Rekap Perizinan</a></li>
                ...
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane active">
                        <div class="panel-body">
                            @include('promosi.content.rekap-kemitraan')
                        </div>
                    </div>
                    <div id="tab-2" class="tab-pane">
                        <div class="panel-body">
                            @include('yanzin.content.rekap-perizinan')
                        </div>
                    </div>
                    <div id="tab-3" class="tab-pane">
                        <div class="panel-body">
                            @include('pdi.content.rek-oss')
                        </div>
                    </div>
                    <div id="tab-4" class="tab-pane">
                        <div class="panel-body">
                            @include('wasdal.content.rekap-pma')
                        </div>
                    </div>
