            ...
            <div class="tabs-container">
                ...
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#tab-1">Form Realisasi Investasi</a></li>
                        <li class=""><a data-toggle="tab" href="#tab-2">Rekap Realisasi Investasi</a></li>
                    </ul>
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane active">
                            <div class="panel-body">
                                @include('wasdal.content.form-pma-invest')
                            </div>
                        </div>
